...
const routes = [
...

  {
    ...
    children: [
      ...
      { path: "shipping", component: AdminShippingPage },
...
router.beforeEach((to, from, next) => {
  ...
  if (requiresAuth) {
    ...
    const roleNeeded = requiredRole?.toUpperCase()

    if (roleNeeded && userRole !== roleNeeded) {
      return next("/") // hoặc redirect về trang thông báo không có quyền
    }
  }
